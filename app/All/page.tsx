...
const products = [
  ...
  { id: "9", img: "card9.png", title: "Miss Rose Purely Natural Foundation - Miss Rose Com Pak" },
  { id: "10", img: "card10.png", title: "Miss Rose Silk Flawless Foundation Ivory 6 - Urban Beauty" },
  { id: "11", img: "card11.png", title: "Miss Rose Silk Flawless Foundation Ivory 6 - Urban Beauty" },
  { id: "12", img: "card12.png", title: "Miss Rose Silk Flawless Foundation Ivory 6 - Urban Beauty" },
  { id: "13", img: "card13.png", title: "Miss Rose Silk Flawless Foundation Ivory 6 - Urban Beauty" },
  { id: "14", img: "card4.png", title: "Miss Rose Silk Flawless Foundation Ivory 6 - Urban Beauty" },
  { id: "15", img: "card8.png", title: "Miss Rose Silk Flawless Foundation Ivory 6 - Urban Beauty" },
  { id: "16", img: "card10.png", title: "Miss Rose Silk Flawless Foundation Ivory 6 - Urban Beauty" },
];
...
const Card = () => {
  return (
    <div>
      ...
      <div className="p-9 flex gap-5 font-serif flex-wrap justify-center">
        {products.map((item, index) => (
          ...
          >
            ...
            <div className="p-2 text-center rounded-b-2xl">
